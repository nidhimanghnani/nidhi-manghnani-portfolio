...
![Referral Hub Home](./screen1_referral_hub_home.png)

**Screen 2 — Referral Detail**

![Referral Detail](./screen2_referral_detail.png)
...
- **Gap Identified:** Referral program exists but has
  no tracking dashboard, links expire in 48 hours, and
